...
namespace SeleniumTests
{
    ...
    public class UntitledTestCase
    {
        ...
        public void TestComCPF_ReturnSucesso()
        {
            ...
            driver.FindElement(By.Id("nome")).SendKeys("Vinicius");
            driver.FindElement(By.Id("Sobrenome")).Clear();
            driver.FindElement(By.Id("Sobrenome")).SendKeys("Mesquita");
            ...
            driver.FindElement(By.Id("CPF")).SendKeys("111111111111");
            driver.FindElement(By.Id("CEP")).Clear();
            driver.FindElement(By.Id("CEP")).SendKeys("5161651");
            driver.FindElement(By.Id("Endereco")).Clear();
            driver.FindElement(By.Id("Endereco")).SendKeys("Rau c");
            driver.FindElement(By.Id("Cidade")).Clear();
            driver.FindElement(By.Id("Cidade")).SendKeys("Lavras");
            driver.FindElement(By.Id("Cargo")).Clear();
            driver.FindElement(By.Id("Cargo")).SendKeys("Desenvolvedor ERP");
            driver.FindElement(By.Id("nomeMae")).Clear();
            driver.FindElement(By.Id("nomeMae")).SendKeys("Maricely");
